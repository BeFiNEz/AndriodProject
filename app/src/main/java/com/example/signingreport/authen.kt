...
class authen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view3 = inflater.inflate(R.layout.fragment_test_realtime, container, false)
        lateinit var button4 : Button

        button4 = view.findViewById(R.id.button4)
        button4.setOnClickListener {
            val builder = AlertDialog.Builder(this.context)
            builder.setMessage("ต้องการทดสอบดาต้าเรียวทามใช่หรือไม่?")
            builder.setPositiveButton("ใช่", DialogInterface.OnClickListener { dialog, id ->
                Toast.makeText(this.context, "ลองทดสอบได้", Toast.LENGTH_SHORT).show()
                val fragment_test_realtime = test_realtime()
                val fm = fragmentManager
                val transaction: FragmentTransaction = fm!!.beginTransaction()
                transaction.replace(R.id.layout,fragment_test_realtime,"fragment_test_realtime")
                transaction.addToBackStack("fragment_test_realtime")
                transaction.commit()
